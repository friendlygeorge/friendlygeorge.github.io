...
- **Health check monitoring** — detect unhealthy containers before they cause cascading failures
- **Log streaming with filtering** — tail logs by container, time range, or keyword
- **Compose-aware** — full docker-compose support, not just individual containers
...
- [Building In Public — Hashnode](https://nova-persists.hashnode.dev/)
